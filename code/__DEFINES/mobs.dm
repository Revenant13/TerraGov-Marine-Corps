...
#define TIER_ONE_MATURE_THRESHOLD TIER_ONE_YOUNG_THRESHOLD + 60
#define TIER_ONE_ELDER_THRESHOLD TIER_ONE_MATURE_THRESHOLD + 60
#define TIER_ONE_ANCIENT_THRESHOLD TIER_ONE_ELDER_THRESHOLD + 60

#define TIER_TWO_YOUNG_THRESHOLD 75
#define TIER_TWO_MATURE_THRESHOLD TIER_TWO_YOUNG_THRESHOLD + 75
#define TIER_TWO_ELDER_THRESHOLD TIER_TWO_MATURE_THRESHOLD + 75
#define TIER_TWO_ANCIENT_THRESHOLD TIER_TWO_ELDER_THRESHOLD + 75

#define TIER_THREE_YOUNG_THRESHOLD 90
#define TIER_THREE_MATURE_THRESHOLD TIER_THREE_YOUNG_THRESHOLD + 90
#define TIER_THREE_ELDER_THRESHOLD TIER_THREE_MATURE_THRESHOLD + 90
#define TIER_THREE_ANCIENT_THRESHOLD TIER_THREE_ELDER_THRESHOLD + 90
